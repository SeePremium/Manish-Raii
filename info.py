...
BOT_TOKEN = environ.get('BOT_TOKEN', '6552804483:AAENZm6OeapYArc_goJHY73plM8Zo_ZGL4c')
...
# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001888487476').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001706117046')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001818298458'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://tufanbhaix24:sunny12@cluster0.vrwi05k.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://dop-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://dop-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://dop-bot.onrender.com/".format(FQDN)
else:
    URL = "https://dop-bot.onrender.com/".format(FQDN)
