...
URL = "https://pap-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://pap-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://pap-bot.onrender.com/".format(FQDN)
else:
    URL = "https://pap-bot.onrender.com/".format(FQDN)
